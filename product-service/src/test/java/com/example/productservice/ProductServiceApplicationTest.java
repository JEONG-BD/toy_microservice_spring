...
class ProductServiceApplicationTest {
    ...
    @Test
    @DisplayName("Successfully produces a product")
    public void shouldCreatedProduct() throws Exception {
        //given
        ProductCreateRequestDTO dto = getProductRequest();
        String productRequest = objectMapper.writeValueAsString(dto);
    ...
    private ProductCreateRequestDTO getProductRequest() {
